   ...
   BEGIN                                                              
	...
	P2: 
		BEGIN		
			...
			INSERT INTO SESSION.TEMP_GEGEVENS (GEAD_ID, GEAD_EORI) VALUES (1200353, 'NL200000071');
			SET H_AANTAL = H_AANTAL + 1; 
			INSERT INTO SESSION.TEMP_GEGEVENS (GEAD_ID, GEAD_EORI) VALUES (443, 'NL200000113');
			SET H_AANTAL = H_AANTAL + 1; 
			INSERT INTO SESSION.TEMP_GEGEVENS (GEAD_ID, GEAD_EORI) VALUES (1709830, 'NL200000599');
			SET H_AANTAL = H_AANTAL + 1; 
			INSERT INTO SESSION.TEMP_GEGEVENS (GEAD_ID, GEAD_EORI) VALUES (481532, 'NL200003606');
			SET H_AANTAL = H_AANTAL + 1;   
			INSERT INTO SESSION.TEMP_GEGEVENS (GEAD_ID, GEAD_EORI) VALUES (511589, 'NL200004398');
			SET H_AANTAL = H_AANTAL + 1;  			
...
-- BEWAAR HET ID VAN LOGISTIEKEAFSPRAAKEXTERN			   
			   
			   SELECT ID INTO H_LOGISTIEKEAFSPRAAKEXTERN_ID FROM LOGISTIEKEAFSPRAAKEXTERN AS H
			   WHERE H.GEADRESSEERDE_ID = H_GEAD_ID;			   
                                                                  
-- TOEVOEGEN NIEUWE LOGISTIEKEAFSPRAAKEXTERN, IS KOPIE VAN BRON   
               ...
               SELECT NEXTVAL FOR SEQBERICHT, 1, S_GEADRESSEERDE_ID, E.BERICHTSTROOM, E.BERICHTTYPE, E.KANAAL, E.BERICHTFORMAAT, '2022-09-30 01:00:00.000000', '9999-12-31 23:59:00.000000', H_USERID, CURRENT TIMESTAMP, E.CSIMSGTYPE, E.SOORTADRES, E.BEWERKING   
               FROM LOGISTIEKEAFSPRAAKEXTERN AS E                              
               WHERE E.GEADRESSEERDE_ID = H_GEAD_ID;    
			                                        
-- BEWAAR NIEUWE ID VAN LOGISTIEKEAFSPRAAKEXTERN   
                                                     
               SET S_LOGISTIEKEAFSPRAAKEXTERN_ID = SEQBERICHT.CURRVAL;                  
                                                     
-- TOEVOEGEN NIEUWE LOGISTIEKADRESEXTERN, IS KOPIE VAN BRON   
               ...
               WHERE L.LOGISTIEKEAFSPRAAKEXTERN_ID = H_LOGISTIEKEAFSPRAAKEXTERN_ID;         				
			
				SET TELLER = TELLER + 1;
				SET H_AANTAL = H_AANTAL + H_GEAD_ID;
      ...
      BEGIN                                             
        SET O_FOUTBOODSCHAP =  
		--  CONCAT('VERWERKING OK: AANTAL = ',IPARID);
